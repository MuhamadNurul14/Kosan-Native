<?php // File: views/check-booking.php ?>
...
<div class="relative flex flex-col gap-[30px] my-[60px] px-5">
    ...
    <form action="<?php echo url('booking-details'); ?>" method="POST" class="flex flex-col rounded-[30px] border border-[#F1F2F6] p-5 gap-6 bg-white">
        ...
        <div id="InputContainer" class="flex flex-col gap-[18px]">
            <div class="flex flex-col w-full gap-2">
                ...
                <label class="flex items-center w-full rounded-full p-[14px_20px] gap-3 bg-white ring-1 ring-[#F1F2F6] focus-within:ring-[#91BF77] transition-all duration-300">
                    ...
                    <input type="text" name="booking_id" required class="appearance-none outline-none w-full font-semibold placeholder:text-ngekos-grey placeholder:font-normal" placeholder="Write your booking id">
                </label>
            </div>
            <div class="flex flex-col w-full gap-2">
